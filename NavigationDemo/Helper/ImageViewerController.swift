...
public final class ImageViewerController: UIViewController {
    ...
    func restartMasterControllerObserver() {
        NotificationCenter.default.addObserver(self, selector: #selector(showHomeController), name: .showHomeScreen, object: nil)
    }
    
    @objc func showHomeController(){
        dismiss(animated: true)
        NotificationCenter.default.removeObserver(self, name: .showHomeScreen, object: nil)
    }
    ...
    override public func viewDidLoad() {
        ...
        self.restartMasterControllerObserver()
    }
    
    public override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
//        self.navigationController!.navigationBar.isHidden = true   //@K

    }
    public override func viewWillDisappear(_ animated: Bool) {
        super.viewWillDisappear(animated)
//        self.navigationController!.navigationBar.isHidden = false  //@K
    ...
    @IBAction func nextBAction(_ sender: Any) {
        ///@K
        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let newViewController = storyBoard.instantiateViewController(withIdentifier: "NextViewController")
