...
class ViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        ///@K
        //        let navController = UINavigationController(rootViewController: ImageViewerController(configuration: configuration)) // Creating a navigation controller with VC1 at the root of the navigation stack.
